...
const ProductCard = ({ product }) => {
  ...
  return (
    <>
      <style>{`
        .gz-card {background:#fff;border:1px solid #e8e8e8;border-radius:12px;overflow:hidden;transition:all 0.3s cubic-bezier(0.16,1,0.3,1);height:100%;display:flex;flex-direction:column;position:relative;box-shadow: 0 2px 8px rgba(0,0,0,0.02);max-width: 270px;width: 100%;margin: 0 auto;}
        ...
        .gz-btn-add-new{flex:1;padding:6px 12px;border-radius:20px;border:1.5px solid #0f0f0f;background:#fff;color:#0f0f0f;font-size:0.72rem;font-weight:700;letter-spacing:0.02em;text-transform:uppercase;cursor:pointer;transition:all 0.2s ease;text-align:center;}
        .gz-btn-add-new:hover{background:rgba(15,15,15,0.05);}
        .gz-btn-add-new:disabled{border-color:#ccc;color:#ccc;background:#fff;cursor:not-allowed;}
